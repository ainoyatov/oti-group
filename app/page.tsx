...
export default function Home() {
  return (
    <div className="flex relative h-screen bg-[url('/main-home.jpg')] bg-cover bg-center">
      ...
      <div className="flex flex-col w-full md:flex-row bg-gray-900/40">
        {/* Left Column: Text Content */}
      <div className="flex-1 flex flex-col justify-center text-white m-8 lg:m-12">
        <div className="flex flex-col text-white text-7xl font-bold">
           <h2>Sell Your House</h2>
           <h2>Fast For Cash!</h2>
         </div>
        <ul className="mt-6 space-y-3 text-3xl max-w-lg font-medium">
          <li>✔ Top Dollar Cash Offer</li>
          <li>✔ Close Within 10 Days</li>
          <li>✔ Sell In Any Condition</li>
        </ul>
        <p className="mt-6 text-2xl max-w-lg">
      ...
      <div className="flex-1 flex justify-center items-center m-8 lg:m-12">
