...
const GoogleReviewsStatic = [
    ...
    { user: "Toneisha James", message: "Great experience With OT Home Buyers group. Helped me get my Grandmother's property taken care of. Very professional & Quick. Thanks Again Vince & OT Home Buyers. Highly recommend!!!" },
    { user: "Patrick Mccormick", message: "What a great experience with Vince and OT Home Buyers. We had been sitting on a vacant house for more than a year. I got texts all the time inquiring when they could make an offer. Then I got a text with a person's name and company. So I looked them up and got a great idea of who I would be dealing with. Talked with Vince on Friday and on Monday he made an offer that made sense to us. They also paid for moving help for possessions we wanted to store and some to move to the curb for sale. Vince was a wonderful help as well. Closing was a breeze and funds were in our account 2 hours later." },
    ...
    { user: "George Robinson", message: "I was in the process of selling my mother’s house, and OT Home Buyers patiently worked with me throughout the entire journey" },
    ...
    { user: "Thomas Shelley", message: "We had been contacted by several groups asking to purchase our property prior to speaking with OT Home Buyers. We are very glad that we went forward with Vince Chimoga who did everything they promised. Through every step, this considerate team answered questions and worked with us to alleviate our concerns. Vince made the on-site visit, saw the poor condition, understood our situation, and made a fair offer. Vince arranged the next steps, giving special attention to all our requests. Because he kept us informed throughout the process, making sure things were moving smoothly, we highly recommend OT Home Buyers." },
  ];
