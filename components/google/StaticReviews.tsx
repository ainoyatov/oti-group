...
const GoogleReviewsStatic = [
  ...
  { user: "Patrick Mccormick", message: "What a great experience with Vince and OT Investment Group. We had been sitting on a vacant house for more than a year..." },
  { user: "Rebecca Myers", message: "Very thorough and hard working." },
  { user: "George Robinson", message: "I was selling my mother's house... OT investments worked with me and waited." },
  { user: "Brian Reiter", message: "Very helpful from start to finish!" },
  { user: "Tim Borgan", message: "Great company to work with. Had a few issues early, but they ensured a smooth transaction." },
  { user: "Shawntell Scott", message: "Wonderful experience. They went out of their way to help with all our needs and time frame." },
  { user: "Thomas Shelley", message: "We had been contacted by several groups... The professionalism of the team at OT Investments was very impressive." },
];
