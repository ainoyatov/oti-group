...
export const blogPostsNew = [
    ...
    },
    {
        ...
        body: `Falling behind on mortgage payments can be overwhelming—but you do have options. Whether you're one month behind or facing foreclosure, taking quick action can help you protect your home and your equity.
...
Meta Tags (500 characters): sell house with liens Dallas TX, property tax liens Fort Worth TX, how to sell with back taxes Texas, cash buyer for lien property DFW, OT Investment Group lien help, can I sell house with IRS lien Texas, sell home with judgment Dallas area, back tax property sale Texas, sell as-is with liens Plano Irving Arlington
        `
    },
    {
